<div class="inline-page-menu my-4">
    <ul class="list-unstyled">
        ...
        <li class="{{ Request::is('seller/delivery-man/earning-active-log*') ?'active':'' }}"><a href="{{ route('seller.delivery-man.earning-active-log', ['id' => $delivery_man['id']]) }}">{{\App\CPU\translate('Order_History_Log')}}</a></li>
